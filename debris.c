...
void loadDebris()
{
	loadConsecutiveTextures(gData.mDebrisTextures, "assets/sprites/DEBRIS.pkg", 6);
	loadConsecutiveTextures(gData.mHeartTextures, "assets/sprites/HEART.pkg", 3);

	gData.mExplosionSFX = loadSoundEffect("assets/music/EXPLOSION.wav");
	gData.mHeartSFX = loadSoundEffect("assets/music/HEART.wav");
}
...
void addDebris(GeoRectangle tRect)
{
...
void addHeartDebris(GeoRectangle tRect)
{
